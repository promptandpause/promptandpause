          ...
          {habits.slice(0, 5).map((habit) => (
            ...
            >
              ...
              <span className={`text-sm flex-1 text-left ${
                todayLogs[habit.id] ? 'text-emerald-700' : 'text-gray-700'
              }`}>
                {habit.name}
              </span>
              {habit.streak > 0 && (
          ...
          <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
            ...
            <DialogContent className="sm:max-w-[425px]">
              ...
              <div className="space-y-4 pt-4">
                ...
                <div>
                  <label className="text-sm font-medium text-gray-700 mb-2 block">Quick Add</label>
                  ...
                  <div className="space-y-2 mt-3">
                    {correlations.slice(0, 3).map((corr) => (
                      <div key={corr.habit} className="flex items-center justify-between text-sm">
                        <span className="text-gray-600">{corr.habit}</span>
                        <span className={`font-medium ${
                          corr.correlation > 0 ? 'text-emerald-600' : 
                          corr.correlation < 0 ? 'text-rose-600' : 'text-gray-500'
                        }`}>
