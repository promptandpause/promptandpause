-- ============================================================================
-- FOCUS AREAS TABLE CREATION
-- ============================================================================
-- This SQL creates the focus_areas table for premium users to store custom focus areas
-- that will be used to personalize AI prompts
--
...
-- SELECT * FROM pg_tables WHERE tablename = 'focus_areas';
