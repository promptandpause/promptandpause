-- ============================================================================
-- FOCUS AREAS REFLECTION COUNT UPDATE
-- ============================================================================
...
-- Step 1: Add reflection_count column to focus_areas table
...
-- NOTES
-- ============================================================================
-- 1. The reflection_count tracks how many times a focus area was used in prompts
-- 2. Counts automatically update when new prompts are generated with focus areas
-- 3. Counts automatically decrement if prompt_focus_area_usage records are deleted
-- 4. The GREATEST(0, ...) ensures counts never go negative
-- 5. Only active focus areas (is_active = true) get their counts updated
-- ============================================================================
