...
UPDATE email_templates SET html_body = '<div style="margin-bottom: 24px;"><p style="color: #374151; font-size: 16px; line-height: 24px; margin: 0 0 16px 0;">Hi {{userName}},</p><p style="color: #374151; font-size: 16px; line-height: 24px; margin: 0 0 16px 0;">Your weekly insights for {{weekStart}} - {{weekEnd}}:</p><div style="background: #F9FAFB; padding: 20px; border-radius: 8px; margin: 16px 0;"><p style="color: #1F2937; font-size: 16px; line-height: 24px; margin: 0 0 16px 0;">{{insights}}</p><div style="display: flex; gap: 24px; margin-top: 16px;"><p style="color: #6B7280; font-size: 14px; margin: 0;"><strong>Reflections:</strong> {{reflectionCount}}</p><p style="color: #6B7280; font-size: 14px; margin: 0;"><strong>Streak:</strong> {{streakDays}} days 🔥</p></div></div></div>' WHERE template_key = 'weekly_digest';
