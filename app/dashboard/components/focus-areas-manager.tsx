      ...
      <div className="flex items-center justify-between gap-3 mb-5">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogTrigger asChild>
           ...
           <DialogContent className={`backdrop-blur-xl border-3 max-h-[90vh] sm:max-h-[85vh] flex flex-col p-0 gap-0 overflow-hidden shadow-2xl ${theme === 'dark' ? 'bg-[#0A0E18] border-white/20 text-white' : 'bg-white border-gray-400 text-gray-900'}`}>
            ...
            <div className={`flex-shrink-0 p-6 pt-5 border-t-2 ${theme === 'dark' ? 'border-white/10 bg-gradient-to-t from-[#0A0E18] to-[#0A0E18]' : 'border-gray-300 bg-gradient-to-t from-gray-50 to-white'}`}>
