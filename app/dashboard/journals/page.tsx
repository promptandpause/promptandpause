...
import { Filter, Plus, Search, Trash2, Pencil, Flame } from "lucide-react"
...
export default function JournalsPage() {
  ...
  return (
    <main className="min-h-screen w-full max-w-6xl mx-auto px-4 md:px-6 py-6 md:py-8 space-y-6">
          ...
          {loading ? (
            ...
            filtered.map((entry) => (
              <motion.div
                ...
                exit={{ opacity: 0, y: -10 }}
                className={`rounded-2xl p-4 ${theme === 'dark' ? 'glass-light' : 'glass-medium'} border border-white/10`}
              >
