...
export const metadata: Metadata = {
  ...
  description:
    'Personalized daily reflection prompts delivered each morning. Track your mood, reduce stress, and find clarity in five minutes of guided introspection.',
  keywords: [
    'mindfulness',
    'reflection',
    'journaling',
  ...
  openGraph: {
    ...
    url: siteUrl,
    title: 'Prompt & Pause - Daily Mindfulness and Reflection Prompts',
    description:
      'Personalized daily reflection prompts delivered each morning. Track your mood, reduce stress, and find clarity in five minutes of guided introspection.',
    images: [
      {
