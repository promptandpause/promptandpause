    ...
    <>
      ...
      <section ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <motion.div style={{ opacity, scale }} className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <motion.div
            ...
            className="mb-6"
          >
            <Cookie className="w-16 h-16 mx-auto mb-6 text-indigo-600" />
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto space-y-20">
          ...
          <div id="types" className="scroll-mt-20">
            ...
            <div className="space-y-6">
              <div className="p-6 bg-slate-50 border border-slate-200 rounded-lg">
                ...
                <p className="text-sm text-slate-500 mt-4">Duration: Session or up to 1 year</p>
              </div>
              ...
              <div className="p-6 bg-slate-50 border border-slate-200 rounded-lg">
                ...
                <p className="text-sm text-slate-500 mt-4">Duration: Up to 1 year</p>
              </div>
              ...
              <div className="p-6 bg-slate-50 border border-slate-200 rounded-lg">
                ...
                <p className="text-slate-600 mb-4">These cookies help us understand how visitors use our Service.</p>
                <ul className="space-y-2 text-slate-600 list-disc list-inside">
                  <li>
                ...
                <p className="text-sm text-slate-500 mt-4">Duration: Up to 2 years</p>
                <p className="text-sm text-slate-500 mt-2">Note: Analytics data is anonymized and aggregated.</p>
              </div>
              ...
              <div className="p-6 bg-slate-50 border border-slate-200 rounded-lg">
                ...
                <p className="text-sm text-slate-500 mt-4">Duration: N/A</p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4 text-slate-600 leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-6">
                <div className="p-4 bg-white border border-slate-200 rounded-lg">
                  ...
                  <p className="text-sm text-slate-500">Authentication and session management cookies.</p>
                  <a
                ...
                <div className="p-4 bg-white border border-slate-200 rounded-lg">
                  ...
                  <p className="text-sm text-slate-500">Payment processing and fraud prevention cookies.</p>
                  <a
                ...
                <div className="p-4 bg-white border border-slate-200 rounded-lg">
                  ...
                  <p className="text-sm text-slate-500">Hosting, analytics, and performance cookies.</p>
                  <a
                ...
                <div className="p-4 bg-white border border-slate-200 rounded-lg">
                  ...
                  <p className="text-sm text-slate-500">Integration cookies (only if you connect Slack).</p>
                  <a
          ...
          <div id="manage" className="scroll-mt-20">
            ...
            <div className="space-y-4 text-slate-600 leading-relaxed">
              ...
              <div className="p-6 bg-slate-50 border border-slate-200 rounded-lg mt-6 space-y-4">
                <div className="flex items-center justify-between p-4 bg-slate-100 border border-slate-200 rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-slate-500">Required for the Service to function</p>
                  </div>
                  <div className="text-indigo-600 font-bold">Always On</div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-slate-100 border border-slate-200 rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-slate-500">Help us improve the Service</p>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-between p-4 bg-slate-100 border border-slate-200 rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-slate-500">Currently not used</p>
                  </div>
                  <div className="text-slate-500 font-bold">N/A</div>
                </div>

                <button
                  onClick={handleSavePreferences}
                  className="w-full mt-4 px-6 py-3 bg-indigo-600 text-white font-bold uppercase hover:bg-indigo-500 transition-colors relative"
                >
                  {saveSuccess ? (
                ...
                {saveSuccess && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: -10 }}
                    className="p-4 bg-indigo-600 text-white rounded-lg flex items-center gap-3"
                  >
                    <Check className="w-5 h-5" />
            ...
            <div className="space-y-4 text-slate-600 leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-6">
                <div className="p-4 bg-white border border-slate-200 rounded-lg">
                  ...
                  <p className="text-sm text-slate-500">Settings → Privacy and security → Cookies</p>
                  <a
                ...
                <div className="p-4 bg-white border border-slate-200 rounded-lg">
                  ...
                  <p className="text-sm text-slate-500">Settings → Privacy & Security → Cookies</p>
                  <a
                ...
                <div className="p-4 bg-white border border-slate-200 rounded-lg">
                  ...
                  <p className="text-sm text-slate-500">Preferences → Privacy → Cookies</p>
                  <a
                ...
                <div className="p-4 bg-white border border-slate-200 rounded-lg">
                  ...
                  <p className="text-sm text-slate-500">Settings → Cookies and site permissions</p>
                  <a
      ...
      <section className="py-20 px-4 bg-slate-200">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 uppercase text-slate-900">Questions About Cookies?</h2>
          <p className="text-xl text-slate-600 mb-8">We're transparent about how we use your data.</p>
          <Link
            href="/contact"
