      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="flex items-center justify-center gap-4 mb-20">
          ...
          <button
            ...
            className="relative w-16 h-8 bg-slate-200 rounded-full transition-all duration-300 hover:bg-[#C8DCCB]"
          >
            <motion.div
              className="absolute top-1 left-1 w-6 h-6 bg-indigo-600 rounded-full"
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
          <motion.div
            ...
            className="backdrop-blur-md bg-slate-100/80 border-2 border-slate-200 p-10 lg:p-12 rounded-3xl hover:shadow-xl transition-all duration-500"
          >
            <div className="inline-block px-4 py-1 bg-slate-100 text-slate-600 text-sm font-medium rounded-full mb-6">
              Free Forever
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="text-xl text-slate-600">per month</div>
            </div>

            <div className="space-y-4 mb-10">
              <div className="flex items-start gap-3">
                <Check className="w-6 h-6 flex-shrink-0 mt-1 text-indigo-600" />
            ...
            <div className="border-t border-slate-200 pt-8 mb-10">
              <p className="text-sm font-medium text-slate-500 mb-4">What's NOT included:</p>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <X className="w-5 h-5 flex-shrink-0 mt-0.5 text-slate-200" />
                  <span className="text-slate-500">Daily prompts (3x/week only)</span>
                </div>
                <div className="flex items-start gap-3">
                  <X className="w-5 h-5 flex-shrink-0 mt-0.5 text-slate-200" />
                  <span className="text-slate-500">Weekly insight digest</span>
                </div>
                <div className="flex items-start gap-3">
                  <X className="w-5 h-5 flex-shrink-0 mt-0.5 text-slate-200" />
                  <span className="text-slate-500">Monthly reflection</span>
                </div>
                <div className="flex items-start gap-3">
                  <X className="w-5 h-5 flex-shrink-0 mt-0.5 text-slate-200" />
                  <span className="text-slate-500">Slack delivery</span>
                </div>
                <div className="flex items-start gap-3">
                  <X className="w-5 h-5 flex-shrink-0 mt-0.5 text-slate-200" />
                  <span className="text-slate-500">Voice note prompts</span>
                </div>
              </div>
            </div>
            ...
            <Link
              href="/auth"
              className="block w-full px-10 py-5 border-2 border-indigo-600 bg-transparent text-indigo-600 text-base font-medium tracking-wide transition-all duration-300 hover:bg-indigo-500 hover:text-white cursor-pointer text-center min-h-[56px] flex items-center justify-center touch-manipulation"
            >
              START FREE
            </Link>
          ...
          <motion.div
            ...
            className="backdrop-blur-md bg-white border-2 border-indigo-600 p-10 lg:p-12 rounded-3xl shadow-2xl hover:shadow-3xl hover:scale-[1.02] transition-all duration-500 relative"
          >
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-6 py-2 bg-indigo-600 text-white text-sm font-medium rounded-full">
              Most Popular
            </div>
            ...
            <AnimatePresence mode="wait">
              {!isAnnual ? (
                ...
                >
                  ...
                  <div className="text-xl text-slate-500">per month</div>
                </motion.div>
              ) : (
                <motion.div
                  key="annual"
                ...
                >
                  ...
                  <div className="text-xl text-slate-600 mb-2">per year</div>
                  <div className="text-sm text-slate-500">£8.25/month - Save £45 vs monthly</div>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            <Link
              href="/pricing"
              className="block w-full px-10 py-5 bg-indigo-600 text-white border-2 border-indigo-600 text-base font-medium tracking-wide transition-all duration-300 hover:bg-indigo-500 cursor-pointer text-center min-h-[56px] flex items-center justify-center touch-manipulation"
            >
        ...
        <p className="text-center text-sm text-slate-500 mt-4 max-w-2xl mx-auto">
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b-2 border-slate-900">
                ...
                <th className="text-center py-6 px-4 text-lg md:text-xl font-bold bg-indigo-600 text-white">Premium</th>
              </tr>
            </thead>
            <tbody className="text-slate-600">
              <tr className="border-b border-slate-200">
                ...
                <td className="py-6 px-4 text-center bg-slate-100 font-bold">Daily (7/week)</td>
              </tr>
              <tr className="border-b border-slate-200">
                <td className="py-6 px-4 font-medium">Reflection archive</td>
                <td className="py-6 px-4 text-center">50 reflections</td>
                <td className="py-6 px-4 text-center bg-slate-100 font-bold">Unlimited</td>
              </tr>
              <tr className="border-b border-slate-200">
                <td className="py-6 px-4 font-medium">Optional check-in</td>
                <td className="py-6 px-4 text-center">Simple</td>
                <td className="py-6 px-4 text-center bg-slate-100 font-bold">Simple</td>
              </tr>
              <tr className="border-b border-slate-200">
                ...
                <td className="py-6 px-4 text-center bg-slate-100">
              ...
              <tr className="border-b border-slate-200">
                ...
                <td className="py-6 px-4 text-center bg-slate-100 font-bold">Email + Slack</td>
              </tr>
              <tr className="border-b border-slate-200">
              ...
              <tr className="border-b border-slate-200">
                ...
                <td className="py-6 px-4 text-center bg-slate-100 font-bold">Fully customizable</td>
              </tr>
              <tr className="border-b border-slate-200">
                ...
                <td className="py-6 px-4 text-center bg-slate-100 font-bold">PDF/TXT</td>
              </tr>
              <tr className="border-b border-slate-200">
                <td className="py-6 px-4 font-medium">Support response time</td>
                <td className="py-6 px-4 text-center">48-72 hours</td>
                <td className="py-6 px-4 text-center bg-slate-100 font-bold">24 hours (priority)</td>
              </tr>
              <tr>
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <motion.div
              key={index}
              initial={false}
              className="border-2 border-slate-200 rounded-2xl overflow-hidden hover:border-indigo-600 transition-colors duration-300"
            >
              <button
              ...
              <AnimatePresence>
                {openIndex === index && (
                  ...
                  >
                    <div className="px-8 pb-6 text-lg md:text-xl leading-relaxed text-slate-600">{faq.answer}</div>
                  </motion.div>
                )}
              </AnimatePresence>
            </motion.div>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="backdrop-blur-xl bg-slate-100/80 border border-slate-200 rounded-3xl p-12 md:p-16 lg:p-20">
      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-10">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="backdrop-blur-md bg-slate-100/80 border border-slate-200 p-10 lg:p-12 rounded-3xl hover:bg-slate-50 hover:shadow-2xl transition-all duration-500"
          >
            <div className="flex gap-1 mb-6">
              {[...Array(5)].map((_, i) => (
                <Sparkles key={i} className="w-5 h-5 fill-indigo-600" />
              ))}
            </div>
            <p className="text-lg md:text-xl leading-relaxed text-slate-600 mb-8 italic">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Premium user - 4 months</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Premium user - 7 months</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Premium user - 11 months</p>
            </div>
          </motion.div>
        </div>
      </div>
...
function EnterpriseSection() {
  return (
    <div className="min-h-screen flex items-center px-6 py-32 bg-slate-50 text-slate-900">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div>
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-500/10 backdrop-blur-md border border-indigo-600/20 rounded-full mb-8">
          ...
          <p className="text-xl md:text-2xl leading-relaxed text-slate-600 mb-12">
            Support mental health across your organization with Prompt & Pause for Teams. Custom pricing for 10+ users.
          </p>
          <div className="space-y-4 mb-12">
            <div className="flex items-start gap-3">
              <TrendingUp className="w-6 h-6 flex-shrink-0 mt-1 text-indigo-600" />
          ...
          <Link
            href="/contact"
            className="inline-flex items-center justify-center px-10 py-5 bg-indigo-600 text-white border-2 border-indigo-600 text-base font-medium tracking-wide transition-all duration-300 hover:bg-indigo-500 cursor-pointer min-h-[56px] touch-manipulation"
          >
            CONTACT SALES
          </Link>
          <p className="text-sm text-slate-500 mt-4">Starting at £75/month for 10 users</p>
        </div>
      </div>
    </div>
  )
...
function FinalCTASection() {
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-32 bg-slate-100">
      <div className="max-w-4xl text-center">
        <h2 className="text-4xl md:text-6xl lg:text-8xl font-bold mb-12 leading-tight text-balance">
          Not Sure Yet? Start Free
        </h2>
        <p className="text-xl md:text-2xl leading-relaxed text-slate-600 mb-16 max-w-3xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center">
          <Link
            href="/"
            className="px-10 py-5 border-2 border-indigo-600 bg-transparent text-indigo-600 text-base font-medium tracking-wide transition-all duration-300 hover:bg-indigo-500 hover:text-white cursor-pointer text-center min-h-[56px] flex items-center justify-center touch-manipulation"
          >
            TRY PREMIUM FREE FOR 7 DAYS
          </Link>
        </div>
        <p className="text-sm text-slate-500 mt-8">Cancel anytime • No contracts • Keep your reflections</p>
      </div>
    </div>
  )
}
